...
const WIZARD_STEPS = [
  ...
  },
  {
    ...
    description: 'Select the platforms you\'re comfortable with',
    options: [
      { value: 'upwork', label: 'Upwork (Freelance)', icon: '💼' },
      { value: 'fiverr', label: 'Fiverr (Services)', icon: '🎨' },
      { value: 'ebay', label: 'eBay (Resale)', icon: '📦' },
      { value: 'freelancer', label: 'Freelancer.com', icon: '🚀' },
    ],
    multi: true,
  },
  {
