...
export default function DualStreamCard({ aiEarned = 0, userEarned = 0, aiTarget = 500, userTarget = 500 }) {
  ...
  return (
    <div className="rounded-2xl bg-slate-900/80 border border-slate-800 p-5">
      <div className="flex items-center gap-2 mb-5">
        ...
        <span className="text-xs font-semibold text-white uppercase tracking-wider">Revenue Streams</span>
      </div>
      ...
      <div className="mb-5">
        ...
        <div className="flex justify-between text-[10px] text-slate-600 mt-1">
          <span>${totalEarned.toFixed(2)} earned</span>
