  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-30 bg-slate-950/90 border-t border-cyan-400/20 backdrop-blur-md px-4 py-2">
      <div className="max-w-screen-xl mx-auto flex items-center justify-between gap-3">
        ...
        {/* Workflow Orbit View */}
        <button onClick={() => onOrbitView(true)} className="flex items-center gap-1.5 px-3 py-1.5 rounded border border-cyan-500/50 text-cyan-400 hover:border-cyan-400 hover:text-cyan-300 transition-all font-orbitron text-[9px] tracking-widest">
